...
<head>
    ...
    <style>
        ...
        .btn-action { text-decoration: none; padding: 4px 8px; border-radius: 4px; font-size: 0.9em; font-weight: bold; }
        ...
        .nav-links a { text-decoration: none; font-weight: bold; margin-right: 20px; font-size: 0.9em; }
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    {{-- nút sửa --}}
                    <a href="?edit={{ $goi['id_goi'] }}" class="btn-action btn-edit">Sửa</a>

                    {{-- nút xóa --}}
                    <a href="{{ url('/trang_admin/goibaoduong/xoa/' . $goi['id_goi']) }}" 
