...
<head>
    ...
    <style>
        ...
        .btn-edit { color: #007bff; text-decoration: none; margin-right: 10px; font-weight: bold; }
        .btn-delete { color: #dc3545; text-decoration: none; cursor: pointer; font-weight: bold; }
        ...
        .bg-warning { background-color: #ffc107; color: #212529; } /* Chờ xác nhận */
        .bg-info { background-color: #17a2b8; }    /* Đã xác nhận */
        .bg-primary { background-color: #007bff; } /* Đang bảo dưỡng */
        .bg-success { background-color: #28a745; } /* Hoàn thành */
        .bg-danger { background-color: #dc3545; }  /* Hủy */

        .filter-form { margin-bottom: 20px; background: #f4f4f4; padding: 15px; border-radius: 8px; }
        .filter-form input, .filter-form select { padding: 6px; margin-right: 5px; border: 1px solid #ccc; border-radius: 4px; }
        .btn-filter { background-color: #333; color: white; border: none; padding: 7px 15px; cursor: pointer; border-radius: 4px; }
    </style>
</head>
...
<body>
    ...
    <p>
        <a href="{{ url('/trang_admin/goibaoduong') }}" style="text-decoration: none; font-weight: bold; color: #28a745;">
